...
let shareCodes = [ // IOS本地脚本用户这个列表填入你要助力的好友的shareCode
  ...
  'MTAxODc2NTEzNTAwMDAwMDAwMjg3MDg2M245A==@MTAxODc2NTEzMzAwMDAw555MDAyNzUwMDA4MQ==@MTAxODc2NTE555zMjAwMDAwMDAzMDI3MTMyOQ==@MTAxODc2NTEzNDAwMDAwMDAz555MDI2MDI4MQ==@MT555AxODcxOTI2NTAwMDAwMDAxOTQ3MjkzMw==',
  //账号二的好友shareCode,不同好友的shareCode中间用@符号隔开
  'MTAxODc2NTEzMjAwMD555AwMDAzMDI3MTMyOQ==@MTAxODcxOTI2NTAw555MDAwMDAyNjA4ODQyMQ==@MTAxODc2NTEzOTAwMDAwM555DAyNzE2MDY2NQ==',
]
...
function readShareCode() {
  return new Promise(resolve => {
    $.get({url: `http://api.turinglabs/api/v1/jd/pet/read/${randomCount}/`}, (err, resp, data) => {
      try {
        if (err) {
